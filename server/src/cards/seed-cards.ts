...
export const SEED_ABILITIES = [
  ...
  {
    code: 'inmunidad_aliados',
    nombre: 'Inmunidad: Aliados',
    descripcion: 'Esta carta no puede ser afectada por la habilidad de ningún Aliado: los efectos de aliado con objetivo fallan sobre ella y los masivos la ignoran (debilitar, destruir, intercambiar control, suprimir habilidades…).',
    implemented: true,
    categoria: 'especial',
    tipos: ['aliado', 'totem', 'arma'],
  },
  {
    code: 'otorga_inmunidad_talismanes',
    nombre: 'Otorga Inmunidad: Talismanes a Patriotas',
    descripcion: 'Mientras esta carta esté en juego, los Aliados de raza Patriota que controle su propietario adquieren la habilidad Inmunidad: Talismanes.',
    implemented: true,
    categoria: 'carta',
    tipos: ['aliado'],
  },
  {
    code: 'trigger_patriota_roba_baraja',
    nombre: 'Patriota entra: roba y baraja',
    descripcion: 'Cada vez que un Aliado Patriota entre en juego, su dueño puede robar 1 carta de su Mazo Castillo y barajar una carta de su Cementerio de vuelta en el Castillo (el mazo se re-aleatoriza).',
    implemented: true,
    categoria: 'carta',
    tipos: ['aliado'],
  },
  ...
  {
    code: 'bonus_patriotas_propios',
    nombre: 'Bonus a tus Patriotas (+1)',
    descripcion: 'Mientras esta carta esté en juego, los Aliados de raza Patriota que controle su propietario ganan +1 a la Fuerza.',
    implemented: true,
    categoria: 'carta',
    tipos: ['aliado', 'totem', 'oro'],
  },
  {
    code: 'oro_traba_rival',
    nombre: 'Traba un Oro rival',
    descripcion: 'Puedes mover este Oro a tu Zona de Oro Pagado para mover un Oro de la Reserva del oponente a su Zona de Oro Pagado (reduce su Oro disponible).',
    implemented: true,
    categoria: 'carta',
    tipos: ['oro'],
  },
  {
    code: 'oro_descarta_talisman',
    nombre: 'Destruir: descarta Talismán rival',
    descripcion: 'Puedes destruir este Oro para mirar la Mano de un oponente y descartarle un Talismán.',
    implemented: true,
    categoria: 'carta',
    tipos: ['oro'],
  },
  {
    code: 'oro_caudillo_x3',
    nombre: 'Genera 3 Oros para Caudillos',
    descripcion: 'Puedes mover este Oro a tu Zona de Oro Pagado para generar 3 Oros que solo pueden usarse para pagar Costes de habilidades de Aliados Caudillos. Expiran al final del turno.',
    implemented: true,
    categoria: 'carta',
    tipos: ['oro'],
  },
  {
    code: 'mano_descarta_roba',
    nombre: 'Descarta desde la mano: roba',
    descripcion: 'Si esta carta está en tu Mano, puedes descartarla para robar una carta de tu Mazo Castillo.',
    implemented: true,
    categoria: 'carta',
    tipos: ['oro', 'aliado', 'arma', 'talisman', 'totem'],
  },
  {
    code: 'mano_tutor_caudillo',
    nombre: 'Remover desde la mano: tutor Caudillo',
    descripcion: 'Si esta carta está en tu Mano, puedes removerla para buscar un Aliado Caudillo en tu Castillo y ponerlo en tu Mano (el mazo se baraja).',
    implemented: true,
    categoria: 'carta',
    tipos: ['oro', 'aliado', 'arma', 'talisman'],
  },
  {
    code: 'suprime_coste1',
    nombre: 'Suprime habilidades de Coste 1',
    descripcion: 'Mientras esta carta esté en juego, todas las cartas en juego de Coste 1 (de ambos jugadores) pierden su habilidad.',
    implemented: true,
    categoria: 'carta',
    tipos: ['oro', 'aliado', 'totem'],
  },
  {
    code: 'revela_mano_caudillos',
    nombre: 'Mano rival descubierta (solo Caudillos)',
    descripcion: 'Mientras controles al menos un Aliado y todos tus Aliados sean de raza Caudillo, tus oponentes juegan con su Mano descubierta.',
    implemented: true,
    categoria: 'carta',
    tipos: ['oro', 'aliado', 'totem'],
  },
