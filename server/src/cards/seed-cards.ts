...
export const SEED_ABILITIES = [
  ...
  {
    code: 'invoca_caudillo_barato',
    nombre: 'Invoca Caudillo ≤3 (paga 2)',
    descripcion: 'Una vez por turno, puedes pagar 2 Oros para jugar un Aliado de raza Caudillo de Coste 3 o menos desde tu Castillo, sin pagar su Coste.',
    implemented: true,
    categoria: 'carta',
    tipos: ['aliado'],
  },
  {
    code: 'fase_final_roba2',
    nombre: 'Fase Final: roba 2',
    descripcion: 'Al comienzo de tu Fase Final, puedes robar 2 cartas de tu Mazo Castillo.',
    implemented: true,
    categoria: 'carta',
    tipos: ['aliado'],
  },
  {
    code: 'otorga_furia_patriotas',
    nombre: 'Otorga Furia a Patriotas',
    descripcion: 'Mientras esta carta esté en juego, los Aliados de raza Patriota que controle su propietario tienen Furia (pueden atacar el turno en que entran en juego).',
    implemented: true,
    categoria: 'carta',
    tipos: ['aliado'],
  },
  {
    code: 'entra_agrupa3',
    nombre: 'Al entrar: agrupa 3 Oros',
    descripcion: 'Cuando esta carta entra en juego, su propietario agrupa automáticamente hasta 3 Oros de su Zona de Oro Pagado de vuelta a su Reserva.',
    implemented: true,
    categoria: 'carta',
    tipos: ['aliado'],
  },
  {
    code: 'suprime_no_caudillo_patriota',
    nombre: 'Suprime habilidades (no Caudillo/Patriota)',
    descripcion: 'Mientras esta carta esté en juego, todos los Aliados que no sean de raza Caudillo ni Patriota (de ambos jugadores) pierden su habilidad.',
    implemented: true,
    categoria: 'carta',
    tipos: ['aliado'],
  },
  {
    code: 'destruye_no_oro',
    nombre: 'Destruir una carta (no Oro)',
    descripcion: 'Una vez por turno, en tu Vigilia, puedes destruir una carta en juego que no sea Oro (aliado, tótem o maquinaria).',
    implemented: true,
    categoria: 'carta',
    tipos: ['aliado'],
  },
  {
    code: 'sin_limite_armas',
    nombre: 'Patriotas sin límite de Armas',
    descripcion: 'Mientras esta carta esté en juego, los Aliados de raza Patriota que controle su propietario no tienen límite de Armas: pueden portar varias, sumando sus bonos y habilidades.',
    implemented: true,
    categoria: 'carta',
    tipos: ['aliado'],
  },
  {
    code: 'bonus_fuerza_con_arma',
    nombre: 'Aliados con Arma: +4 Fuerza',
    descripcion: 'Mientras esta carta esté en juego, los Aliados que controle su propietario que porten al menos un Arma ganan +4 a la Fuerza.',
    implemented: true,
    categoria: 'carta',
    tipos: ['aliado'],
  },
